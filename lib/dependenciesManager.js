...
export default class DependenciesManager {
    ...
    getLocalDependencies() {
        return Object
            ...
            .filter(
                (dependency) => this.regexes.local.test(this.dependencies[dependency])
                    || this.regexes.file.test(this.dependencies[dependency])
            )
            .reduce(
                (localDependencies, currentDependency) => Object.assign(
                    localDependencies,
    ...
    detectDuplicatedDependencies(from, dependencies) {
        const duplicates = Object.keys(dependencies).filter((x) => Object.keys(this.dependencies).includes(x));
