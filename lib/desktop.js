...
export default class Desktop {
    ...
    gatherModuleConfigs() {
        ...
        if (!isEmptySync(this.$.env.paths.desktop.modules)) {
            const modulesDir = this.$.env.paths.desktop.modules;
    ...
    scaffold() {
        ...
        fs.cpSync(this.$.env.paths.scaffold, this.$.env.paths.desktop.root, { recursive: true });
        fs.mkdirSync(this.$.env.paths.desktop.import, { recursive: true });
