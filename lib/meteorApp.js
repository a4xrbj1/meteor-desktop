            ...
            if (missingSrcs.length > 0) {
                ...
                if (missingSrcs.length === 1 && unreferencedFiles.length === 1) {
                    ...
                    throw new Error(
                        ...
                        + ` ${unreferencedFiles.length} unreferenced JS file(s) found — cannot auto-repair:\n${srcList}`
                    );
                }
            }
        } catch (e) {
