...
`;
            ...
            const buildTypes = ['main-dev', 'main-prod'];
            ...
            if (activeBuildDir && sourceJs) {
                ...
                try {
                    ...
                    // 4. Update program.json manifest for ALL chunks
                    ...
                    // 5. Wrap module.link calls
                    const appJsPath = path.join(meteorAppDir, 'app', 'app.js');
